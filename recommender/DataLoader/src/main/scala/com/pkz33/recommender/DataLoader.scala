...
object DataLoader {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val config = Map(
      ...
      "es.httpHosts" -> "pkz33:9200",
      "es.transportHosts" -> "pkz33:9300",
    ...
    // 数据预处理，把movie对应的tag信息添加进去，添加一列 tag1|tag2|tag3...
